...
class ShoppingBagViewModel: ViewModel() {
    ...
    private val okHttpClient = OkHttpClient.Builder()
        ...
        .build()
    fun PostingProductsFromApi(id:Int){
        ...
        val task: Call<ProductResponse> = productApiService.addShoppingProduct(id);
    ...
    fun GetProductFromApi(){
        ...
        val httpClient = Retrofit.Builder()
            ...
            .build()
        val productApiService: ProductApiService = httpClient.create(ProductApiService::class.java);
        val task: Call<ProductResponse> = productApiService.getShoppingProduct();
    ...
    fun DeleteProductFromApi(){
        ...
        val httpClient = Retrofit.Builder()
            ...
            .build()
        val productApiService: ProductApiService = httpClient.create(ProductApiService::class.java);
        val task: Call<ProductResponse> = productApiService.payShoppingProduct();
